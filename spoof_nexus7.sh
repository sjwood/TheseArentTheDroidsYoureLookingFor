...
change_build_property "ro.product.model" "Nexus 7"
change_build_property "ro.product.brand" "google"
change_build_property "ro.product.name" "razor"
change_build_property "ro.product.device" "flo"
change_build_property "ro.product.manufacturer" "asus"
change_build_property "ro.build.description" "razor-user 6.0.1 MOB30X 3036618 release-keys"
change_build_property "ro.build.fingerprint" "google/razor/flo:6.0.1/MOB30X/3036618:user/release-keys"
